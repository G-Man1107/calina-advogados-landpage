    ...
    <section id="contato" className="py-24 md:py-32 bg-background">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl text-foreground mb-2 font-normal md:text-3xl">Contato</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <Input placeholder="Seu nome" required className="bg-accent border-border" />
            <Input type="email" placeholder="Seu e-mail" required className="bg-accent border-border" />
            <Textarea placeholder="Sua mensagem" required className="bg-accent border-border min-h-[120px]" />

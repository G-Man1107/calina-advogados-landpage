...
const valores = [
  { icon: Scale, titulo: "Ética", descricao: "Compromisso absoluto com a conduta ética e transparente em todas as relações." },
  { icon: Shield, titulo: "Comprometimento", descricao: "Dedicação integral a cada caso, tratando cada cliente com a devida atenção." },
  { icon: Award, titulo: "Excelência", descricao: "Busca contínua pela qualidade e atualização jurídica para os melhores resultados." },
];
    ...
    <section id="sobre" className="py-24 md:py-32 bg-background">
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-4xl text-foreground mb-2">Sobre o Escritório</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {valores.map((valor) => (
            <div key={valor.titulo} className="text-center group">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">{valor.descricao}</p>
            </div>
          ))}
        </div>
      </div>

...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center py-32 flex flex-col items-center">
        <h1 className="text-3xl md:text-5xl lg:text-6xl text-primary-foreground leading-tight font-semibold max-w-4xl">
          Registro de Marca, Recuperação de Créditos e Defesas Tributárias
        </h1>
        <p className="mt-6 text-base md:text-lg text-primary-foreground/80 max-w-2xl mx-auto leading-relaxed font-light">

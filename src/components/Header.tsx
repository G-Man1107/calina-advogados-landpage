  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-primary-dark/95 backdrop-blur-sm border-b border-primary/20">
      <div className="container mx-auto px-6 py-4">
        ...
        {/* Contact info bar */}
        <div className="hidden md:flex items-center justify-end gap-6 mt-2 pt-2 border-t border-primary/10">
          <a 
            href="https://instagram.com/calinaadvogados" 
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-primary-foreground/60 hover:text-primary-foreground text-xs transition-colors"
          >
            <Instagram size={14} />
